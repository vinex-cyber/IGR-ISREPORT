...
: string => {
  ...
  return `
        SELECT 
            alamat, 
            Jenis,
            PRD_KODEDIVISI as prd_kodedivisi,
            PRD_KODEDEPARTEMENT as prd_kodedepartement,
            PRD_KODEKATEGORIBARANG as prd_kodekategoribarang,
            PRD_PRDCD as prd_prdcd,
            PRD_DESKRIPSIPANJANG as prd_deskripsipanjang,
            PRD_FRAC as prd_frac,
            PRD_KODETAG as prd_kodetag,
            plano,
            LPP,
            ACOST,
            PKM_PKMT,
            AVG_REG,
            AVG_MM,
            HGB_KODESUPPLIER as hgb_kodesupplier,
            sup_namasupplier,
